...
namespace Coingate.Net
{
    public class Coingate
    {
        ...
        /// </summary>
        /// <param name="resourcePath">/v1/orders or defined</param>
        /// <param name="pageNo"></param>
        /// <param name="pageSize"></param>
        /// <param name="sort"></param>
        /// <returns></returns>
        public async Task<dynamic> GetOrders(string resourcePath = "/v1/orders/", int pageNo = 1, int pageSize = 10, string sort = "created_at_desc")
        {
        ...
        /// <returns></returns>
        public async Task<dynamic> GetOrder(int orderId, string resourcePath = "/v1/orders/")
        {
            _client.BaseAddress = new Uri(_baseUri);
            ConfigureHeaders(Signature());
